...
public class BiPredicateInterfaceImp {
	...
	public static void main(String[] args) {
		...
		BiPredicate<String, String> biPredicate2 = (message, message1) -> {
		...
		BiPredicate<StudentVo, String> biPredicate3=(studentVo,collegeName)->{if(studentVo.getCollegeName().equalsIgnoreCase(collegeName)) {
		return true;	
		}
		return false;
		};
